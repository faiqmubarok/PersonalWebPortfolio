...
const Layout = ({ children }) => {
  ...
  const handleSidebar = (state) => setSidebarOpen(state);
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full mx-auto max-w-screen-xl px-4 md:px-8 lg:px-0 py-12 gap-24 lg:gap-60">
        <motion.header className="w-full" {...motionVariants.fromTop}>
          <Header onSidebarOpen={() => handleSidebar(true)} />
        </motion.header>
      ...
      <Sidebar
        ...
        onSidebarClose={() => handleSidebar(false)}
      />
