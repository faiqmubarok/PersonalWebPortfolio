...
const Resume = () => {
  ...
  const certification = [
    ...
    },
    {
      ...
      title: "Learn ReactJS",
      year: "2024",
      thumb: images.thumb01,
      image: images.certificate01,
    },
    {
      publisher: "Edspert.id",
      title: "Web Development For Beginner",
      year: "2024",
      thumb: images.thumb03,
      image: images.certificate04,
    },
    {
      publisher: "Edspert.id",
      title: "Start Learning IoT From Zero",
      year: "2024",
      thumb: images.thumb04,
      image: images.certificate03,
    },
    {
      publisher: "JadiHacker",
      title: "Blockchain And Cryptography",
      year: "2024",
      thumb: images.thumb05,
      image: images.certificate05,
    },
    {
      publisher: "AWS Cloud Club",
      title: "AWS Cloud Computing",
      year: "2024",
      thumb: images.thumb06,
      image: images.certificate06,
    },
    {
      publisher: "SCB International Consulting",
      title: "Be a Great Speaker",
      year: "2023",
      thumb: images.thumb02,
      image: images.certificate02,
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-3">
              ...
              <ul className="flex flex-col gap-4 lg:gap-3">
                {education.map((item, index) => (
                  ...
                  >
                    ...
                    <h4 className="font-medium text-base dark:text-white">
                      {item.school}
                    </h4>
            ...
            <div className="flex flex-col gap-5 w-full">
              <div className="flex gap-3 items-center font-poppins font-semibold text-xl text-black dark:text-white">
                ...
                >
                  <path
                    d="M27.1875 15.9375V26.25H2.8125V15.9375M15 20.625V16.875M18.75 7.5C18.75 7.5 18.75 3.75 15 3.75C11.25 3.75 11.25 7.5 11.25 7.5M1.875 7.5H28.125V15C28.125 15 22.5 18.75 15 18.75C7.5 18.75 1.875 15 1.875 15V7.5Z"
                    stroke="currentColor"
                    strokeWidth="1.25"
                    strokeLinecap="round"
            ...
            <table className="w-full text-sm text-left text-lightSecondary dark:text-darkSecondary">
              ...
              <tbody>
                {organization.map((item, index) => (
                  <tr
                    key={index}
                    className="bg-transparent border-b border-[#e3e3e3] dark:border-[#353535] text-sm"
                  >
